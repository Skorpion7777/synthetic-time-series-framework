...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # import network
    gen_net = Generator(seq_len= args.lenn, channels=1, num_classes=5, latent_dim=100, data_embed_dim=10, 
                        label_embed_dim=10 ,depth=3, num_heads=5, 
                        forward_drop_rate=0.5, attn_drop_rate=0.5)
    
    print(gen_net)
    dis_net = Discriminator(in_channels=1, patch_size=1, data_emb_size=50, label_emb_size=10, seq_length = args.lenn, depth=3, n_classes=5)
    print(dis_net)
